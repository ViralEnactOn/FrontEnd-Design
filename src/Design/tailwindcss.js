...
function tailwindcss () {
  ...
  return (
    <>
      ...
      ></div>
      <div className='bg-gray-300 font-qs w-screen'>
        <div className='flex flex-row w-screen'>
          {/* Side bar */}
          <div className='relative flex flex-col basis-1/6 bg-white h-screen pt-20 transition-property: none'>
            {/* Logo */}
            ...
            <div className='flex justify-between'>
              <div>
                <div className='relative block'>
                  ...
                  <input
                    type='text'
                    className='w-80 h-10 rounded-3xl px-8 placeholder-slate-400 opacity-40 flex-shrink-0'
                    placeholder='Search online stores'
                  />
                </div>
              </div>

              <div className='w-10 h-10 rounded-lg bg-slate-500 relative opacity-30'>
            ...
            <div className='relative block mt-20 bg-white rounded-lg'>
              ...
              <div className='flex justify-between'>
                ...
                <div className='w-1/2 self-center'>
                  <img
                    src={Shop}
                    className='rounded-full rounded-r-lg h-96 w-full'
                    alt='Shop Logo'
                  />
                </div>
              </div>
                    ...
                    <div className='flex justify-between'>
                      ...
                      <div className='flex w-1/2 ml-10'>
                        <div className='flex self-center justify-between '>
                          ...
                          <div className=' font-DESCRIPTION text-xs opacity-50 w-1/2 '>
                            Feb
                          </div>
                        </div>
                      </div>
